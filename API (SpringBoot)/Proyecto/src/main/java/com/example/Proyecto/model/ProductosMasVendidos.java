...
public class ProductosMasVendidos {
    ...
    // Constructor
    public ProductosMasVendidos(Long idProducto, String nombreProducto, String categoriaProducto,
                                String descripcionProducto, BigDecimal precioProducto,
                                Integer stockMin, Long cantidadVendida) {
