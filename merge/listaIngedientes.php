...
foreach ($Ingredientes as $ingrediente) {
    echo "idIngrediente: " . $ingrediente->idIngrediente . "\n";
    echo "idProveedor: " . $ingrediente->idProveedor . "\n";
    echo "idCategoria: " . $ingrediente->idCategoria . "\n";
    echo "nombreIngrediente: " . $ingrediente->nombreIngrediente . "\n";
    echo "cantidadIngrediente: " . $ingrediente->cantidadIngrediente . "\n";
    echo "fechaVencimiento: " . $ingrediente->fechaVencimiento . "\n"; 
    echo "referenciaIngrediente: " . $ingrediente->referenciaIngrediente . "\n";
    echo "fechaEntregaIngrediente: " . $ingrediente->fechaEntregaIngrediente . "\n";
    echo "----------------------------------\n";
}
