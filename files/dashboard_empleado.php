...
<body>
    ...
    <div class="container">
        ...
        <div class="actions-grid">
            ...
            <div class="action-card">
                <h3>👤 Mi Perfil</h3>
                <a href="perfil_empleado.php" class="action-btn">Editar Perfil</a>
                <a href="#" class="action-btn">Cambiar Contraseña</a>
                <a href="logout.php" class="action-btn warning-btn">Cerrar Sesión</a>
            </div>
    ...
    <script>
        ...
        (function() {
            ...
            // Escuchar el evento popstate (botón atrás) de manera inteligente
            window.addEventListener('popstate', function(event) {
                backButtonAttempts++;
                
                // Solo confirmar salida después de múltiples intentos y si no está navegando internamente
                if (backButtonAttempts > 2 && !isNavigatingWithinSystem) {
                    if (confirm('¿Estás seguro de que quieres cerrar la sesión de empleado?')) {
                    ...
                    console.log('Navegación permitida para empleado, intento:', backButtonAttempts);
                    history.pushState(null, null, window.location.pathname);
                }
                
                // Resetear flag de navegación interna
                setTimeout(() => {
