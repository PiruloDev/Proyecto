...
public class ConexionControllerUsers {
    ...
    public ResponseEntity<String> actualizarEmpleado(@PathVariable int id, @RequestBody Map<String, Object> camposActualizar){
        boolean actualizado = conexionEmpleadoService.actualizarEmpleado(id, camposActualizar);
        if(actualizado) {
